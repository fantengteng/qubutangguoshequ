...
- (void)tt_setupViewsFrame {
    self.ImageLayer.frame = CGRectMake(self.V_screnW / 2 - 100 , self.V_screnH / 2 - 87.5,200, 160);
    self.textLayer.frame  = CGRectMake(0, CGRectGetMaxY(self.ImageLayer.frame) + 10, self.V_screnW, 18);
}
